...
- [decisions.md](wiki/decisions.md) — Locked tech/design decisions (D1–D40) — the settled calls future briefs and reviews must not relitigate without an explicit revisit + log note.
