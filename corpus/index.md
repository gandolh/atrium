...
- [decisions.md](wiki/decisions.md) — Locked tech/design decisions (D1–D38) — the settled calls future briefs and reviews must not relitigate without an explicit revisit + log note.
...
- [latex.md](wiki/latex.md) — The /latex destination — projects, the compile job, publishing into the library as versioned documents, and where the sandbox actually lives now that the engine is pure.
